...
void MPDomainAssembly::apply( Pose & pose ) {
	...
	// read constraints-file and weight if available
	core::scoring::constraints::add_fa_constraints_from_cmdline( full_pose, *sfxn_ );
...
void MPDomainAssembly::init_from_cmd() {
	...
	// constraint fa-file and fa-weight are read in apply-function, line 653
