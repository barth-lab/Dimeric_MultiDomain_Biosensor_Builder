...
# PDB
#$R/source/bin/score_jd2.linuxgccdebug -in:file:silent $1 -membrane:Membed_init -membrane::Mhbond_depth -score:weights membrane_highres -spanfile TM.span -no_nstruct_label -loops:chainbreak_max_accept 1.0
#$R/source/bin/score_jd2.linuxgccdebug -in:file:silent $1 -no_nstruct_label -loops:chainbreak_max_accept 1.0

$R/source/bin/score_jd2.linuxgccdebug -in:file:s $1
